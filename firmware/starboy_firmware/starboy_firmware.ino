...
// ============================================================
// 500+ animations | 100 colorways × 4 eye shapes
// Unofficial fan build, inspired by Creature's starboy (lilguy.net). Not affiliated.
...
// Eye style, colours and odds are based on Creature's public eye gallery; the
// colorway names are our own. Each eye is a flat block of colour on
...
const Colorway COLORWAYS[100] = {
  { "tangerine",    0xF99F05, 0x6E6123, 0x6E6123, 10 },
  { "pistachio",    0xC7FBA6, 0x5E6E06, 0x5E6E06, 10 },
  { "fern",         0x039442, 0x71FF6F, 0x71FF6F, 10 },
  { "lagoon",       0x6FF5D0, 0x106E54, 0x106E54, 10 },
  { "deepsea",      0x0059A3, 0x0095FF, 0x0095FF, 10 },
  { "cricket",      0x42DE86, 0x436A16, 0x436A16, 10 },
  { "chambray",     0x6C92F8, 0x102A6E, 0x102A6E, 10 },
  { "orchid",       0xF8AFFB, 0xF006B4, 0xF006B4, 10 },
  { "raspberry",    0xA10180, 0xFC609C, 0xFC609C, 10 },
  { "grapefruit",   0xF6759F, 0x56031F, 0x56031F, 10 },
  { "ruby",         0xAE0002, 0xFF5252, 0xFF5252, 10 },
  { "slate",        0x645252, 0xA4A4A4, 0xA4A4A4, 10 },
  { "fuchsia",      0xDD06CB, 0x7B1612, 0x7B1612, 10 },
  { "violet",       0x7260E6, 0x622058, 0x622058, 10 },
  { "firetruck",    0xF20F07, 0xFFFFFF, 0xFFFFFF,  8 },
  { "clover",       0x59BF05, 0xFFFFFF, 0xFFFFFF,  8 },
  { "skyline",      0x05A8F9, 0xFCEEEE, 0xFCEEEE,  8 },
  { "midnight",     0x4028FF, 0xEBFFFC, 0xEBFFFC,  8 },
  { "confetti",     0xF442E7, 0xFFFFFF, 0xFFFFFF,  8 },
  { "frost",        0xFBFBFB, 0x167B61, 0x167B61,  9 },
  { "redeye",       0xFFFFFF, 0xFF0000, 0xFF0000,  9 },
  { "cloud",        0xFFFFFF, 0x5A79F3, 0x5A79F3,  9 },
  { "yogurt",       0xFFECE0, 0xCE0959, 0xCE0959,  9 },
  { "apricot",      0xFDFBE2, 0xF76E5D, 0xF76E5D,  9 },
  { "sunbeam",      0xE0F4FB, 0xDE9109, 0xDE9109,  9 },
  { "porcelain",    0xFCD9CF, 0x070571, 0x070571,  9 },
  { "lavender",     0xE1BFE1, 0x2722DB, 0x2722DB,  9 },
  { "lemonade",     0xF9FFB2, 0xCA00CA, 0xCA00CA,  9 },
  { "mojito",       0xEAFCC5, 0x09B6CE, 0x09B6CE,  9 },
  { "butter",       0xF6E5A5, 0x0D73F7, 0x0D73F7,  9 },
  { "peppermint",   0x9CFBD5, 0x790C05, 0x790C05,  9 },
  { "beetle",       0xC3110E, 0x000000, 0x000000,  7 },
  { "olive",        0x8BD67C, 0x230606, 0x230606,  7 },
  { "abyss",        0x0F7BA9, 0x000000, 0x000000,  7 },
  { "amethyst",     0xE202E8, 0x0A0A0A, 0x0A0A0A,  7 },
  { "classic",      0xFFFFFF, 0x000000, 0x000000,  7 },
  { "coral",        0xF95320, 0x044A5F, 0x044A5F,  3 },
  { "halloween",    0xE87102, 0x55FC6E, 0x55FC6E,  3 },
  { "citrus",       0xF6FD21, 0x1C9DE3, 0x1C9DE3,  3 },
  { "radioactive",  0xE9F905, 0x360342, 0x360342,  3 },
  { "electric",     0xC4F41D, 0x530AEC, 0x530AEC,  3 },
  { "neon",         0x95F124, 0xF50DCF, 0xF50DCF,  3 },
  { "parrot",       0x55F927, 0x9F7717, 0x9F7717,  3 },
  { "venus",        0x15F817, 0x5E045E, 0x5E045E,  3 },
  { "emerald",      0x14DA70, 0x3516AF, 0x3516AF,  3 },
  { "dusk",         0xAE2400, 0xF855FC, 0xF855FC,  3 },
  { "bluebird",     0x15ABF8, 0x5E2304, 0x5E2304,  3 },
  { "disco",        0x024BDE, 0xFB4CC3, 0xFB4CC3,  3 },
  { "starlight",    0x7B43F5, 0xF6BD49, 0xF6BD49,  3 },
  { "radar",        0x126487, 0x2EE605, 0x2EE605,  3 },
  { "papaya",       0x84FB8E, 0xF64982, 0xF64982,  3 },
  { "uv",           0x6922F0, 0xA3F410, 0xA3F410,  3 },
  { "bubblewrap",   0xF474DC, 0xE8FCA6, 0xE8FCA6,  3 },
  { "grape",        0x7202FC, 0xFDB0CE, 0xFDB0CE,  3 },
  { "firefly",      0x7768FE, 0x55FC87, 0x55FC87,  3 },
  { "magenta",      0xD602E8, 0xFBF823, 0xFBF823,  3 },
  { "forest",       0x1E6935, 0xFC7AC0, 0xFC7AC0,  3 },
  { "tropic",       0x018335, 0x23FAFB, 0x23FAFB,  3 },
  { "alien",        0xF40DF8, 0x19F515, 0x19F515,  3 },
  { "wintergreen",  0x9CFBCE, 0x790572, 0x790572,  3 },
  { "arcade",       0xFA486F, 0x92FABE, 0x92FABE,  3 },
  { "harbor",       0x14ABD6, 0xEEFA24, 0xEEFA24,  3 },
  { "snowcone",     0xC206AD, 0x49F6D9, 0x49F6D9,  3 },
  { "alarm",        0xFD0C0D, 0x2905E6, 0x2905E6,  3 },
  { "heatwave",     0x994400, 0x00EEFF, 0x00EEFF,  3 },
  { "bruise",       0xB60080, 0x429EFB, 0x429EFB,  3 },
  { "iceberg",      0x71FEAE, 0x5598FC, 0x5598FC,  3 },
  { "pitaya",       0xB60053, 0xCFFA0F, 0xCFFA0F,  3 },
  { "rosehip",      0xB6003C, 0x05E605, 0x05E605,  3 },
  { "beet",         0xC5013C, 0x09CE93, 0x09CE93,  3 },
  { "wax",          0x973849, 0xF7FBBC, 0xF7FBBC,  3 },
  { "pixel",        0x737373, 0x09E151, 0x09E151,  3 },
  { "chime",        0xBEBEBE, 0xE42D06, 0xE42D06,  3 },
  { "letter",       0xBE6A6A, 0x76D8EB, 0x76D8EB,  5 },
  { "terracotta",   0xCC6262, 0x3E4002, 0x3E4002,  5 },
  { "fruitpunch",   0xF6826C, 0x95059B, 0x95059B,  5 },
  { "duckpond",     0x7B8401, 0x0737A7, 0x0737A7,  5 },
  { "ketchup",      0x60A611, 0xB4040F, 0xB4040F,  5 },
  { "honey",        0x509156, 0xF4C524, 0xF4C524,  5 },
  { "mermaid",      0x02B0B6, 0x7923FB, 0x7923FB,  5 },
  { "sandcastle",   0xB8804A, 0xF7F574, 0xF7F574,  5 },
  { "balloon",      0x7DB5F4, 0xC10787, 0xC10787,  5 },
  { "swamp",        0xA7AFF6, 0x837605, 0x837605,  5 },
  { "dustbunny",    0xEC75F6, 0x564803, 0x564803,  5 },
  { "sakura",       0xFCB7F2, 0x069A1E, 0x069A1E,  5 },
  { "riverbank",    0xFCB7C3, 0x068F9A, 0x068F9A,  5 },
  { "tv",           0x666666, 0x000000, 0xFFFFFF,  2 },
  { "pencil",       0x666666, 0xFFEDED, 0x000000,  2 },
  { "pinwheel",     0xB60207, 0xD2F9F9, 0x60D105,  2 },
  { "argyle",       0xB865A8, 0x76D8EB, 0x8F1716,  2 },
  { "carp",         0xFE6873, 0x0A0A0A, 0xD0F910,  2 },
  { "pearl",        0xD1D9FA, 0xC11207, 0xD20ADF,  2 },
  { "traffic",      0x34F7FD, 0x038C03, 0xF91024,  2 },
  { "wasp",         0xFDCB21, 0x0A0A0A, 0xD10566,  2 },
  { "pond",         0xD1F63B, 0x10812B, 0x0F91F4,  2 },
  { "movie",        0xEAF66E, 0xBB240A, 0x0964E7,  2 },
  { "tricolor",     0xF6EAB9, 0x177E39, 0x2722DB,  2 },
  { "parasol",      0xE7E3E9, 0xF65F28, 0x4F6BF8,  2 },
  { "gelato",       0xE4F4E2, 0x4A0A99, 0xDB8405,  2 },
  { "triple",       0x87493B, 0xEB76DD, 0xB7ABF3,  2 },
};
